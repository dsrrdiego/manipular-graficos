...
imagen.onload=function(){
    ...
    const fondoGris=engrisar(ctx.getImageData(0,0,canvas.width,canvas.height));
    ...
    const fondoGrisOriginal=engrisar(ctx.getImageData(0,0,canvas.width,canvas.height));
    borrarPantalla();
    refresh();
